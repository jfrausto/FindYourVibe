    ...
    <div className="mt-2">
      {
        ...
        UserBlurbs.reverse().map((blurb) => {
          return (
            <Container
              className="postDivContainerBackground mb-2 p-2"
              key={blurb._id}
            >
              <Row>
                <Col
                  className="postColColor my-auto"
                  xs={2}
                  lg={{ span: 2, offset: 3 }}
                >
                  <img
                    className="postSongImage"
              ...
              <Row>
                <Col
                  ...
                  className="postColColor my-auto"
                >
                  <p className="postBlurb">{blurb.body}</p>
                </Col>
              </Row>
              <Row className="postFooter">
                <Col
                  ...
                  className="postColColor my-auto"
                >
                  <p className="postDate">{handleDateFormat(blurb.time)}</p>
                </Col>
                <Col xs={4} lg={3} className="postColColor my-auto">
                  <p>
                    Vibe: <span className="postVibeEmoji">{blurb.vibe}</span>
                  </p>
                </Col>
              </Row>
            </Container>
