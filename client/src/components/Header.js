  ...
  <div className="headerContainer">
    <main>
      ...
      <footer className='footer'>
        ...
        <Link className='ripple noselect' to="/howto">Learn More</Link>
    ...
    </div> <div className="wavySvgBackground"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="white" fillOpacity="1" d="M0,0L48,32C96,64,192,128,288,149.3C384,171,480,149,576,128C672,107,768,85,864,69.3C960,53,1056,43,1152,53.3C1248,64,1344,96,1392,112L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
   </div>
     </main>
