  ...
  <div className="headerContainer">
    <main>
      ...
      <footer className='footer'>
        <a className='ripple noselect'>Get Started now</a>
      </footer>
